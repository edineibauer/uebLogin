...
if (defined("GOOGLELOGINCLIENTID") && !empty(GOOGLELOGINCLIENTID) && defined('GOOGLEENTITY') && !empty(GOOGLEENTITY)) {
    if (file_exists(PATH_HOME . "entity/cache/" . GOOGLEENTITY . ".json")) {
        if (!SERVICEWORKER && HOME === "" && HOME !== SERVER) {
            echo "<iframe src='" . SERVER . "loginBtnGoogle' frameborder='0' scrolling='no' id='googleLoginFrame' style='width: 165px;border: 0;height: 45px; float: left;border-radius: 3px;'></iframe>";
        } else {
            ?>
